...
class MoiraiProposer:
    ...
    `n_samples` — TOÀN BỘ N sample được sinh ra CHỈ TRONG 1 LẦN GỌI, không cần
    lặp lại như vòng lặp temperature của Chronos.
    """
...
class PhysicsInformedEvaluator:
    ...
    def visualize_A_candidates(
        ...
        file_name = "moirai_A_candidates_spaghetti_vs_groundtruth_2.0.png"
